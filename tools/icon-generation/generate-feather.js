...
const jsonPath = path.join(__dirname, 'data/feather-icons.json');
const outputPath = path.join(__dirname, '../../src/BlazorBlueprint.Icons.Feather/Data/FeatherIconData.cs');
