...
- Permanent live examples, copyable snippets and API reference entries accompany each addition. Implementation and verification status are tracked in `docs/implementation/2026-09-16-parity-progress.md`.
